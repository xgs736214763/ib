<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"G:\wamp64\www\ib5/application/index\view\updatepoint\floor.html";i:1501215073;s:59:"G:\wamp64\www\ib5/application/index\view\Public\header.html";i:1504771462;s:59:"G:\wamp64\www\ib5/application/index\view\Public\footer.html";i:1504769960;}*/ ?>
<!DOCTYPE html>
<html lang="en">
					...
					<div class="panel-body">
						<div class="dataTable_wrapper">
							<div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
								<div class="row">
									<div class="col-sm-6">
										<form action="__URL__/floor" method="get">
											<div class="dataTables_filter">
												<label>选择广场:</label>
												<select name="campus_id" id="campus_id" class="required">
													<option value="">请选择广场</option>
													<?php if(is_array($squarelist) || $squarelist instanceof \think\Collection || $squarelist instanceof \think\Paginator): $i = 0; $__LIST__ = $squarelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
											...
											<tbody>
												<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
													<tr class="gradeA odd" role="row">
														...
														<td>
															<?php echo $vo['floor_name']; ?>
														</td>
														<td>
															<a href="__URL__/position?floor_id=<?php echo $vo['id']; ?>&campus_id=<?php echo $vo['campus_id']; ?>&building_id=<?php echo $vo['building_id']; ?>">矫正点位标注</a>
														</td>
		...
		<form class="form-horizontal">
			<div class="row">
				<div class="control-group span8">
					...
					<div class="controls">
						<input type="text" id="username" name="username" class="input-normal control-text" style="height:30px;">
					</div>
				</div>
				<!-- <div class="control-group span8">
            ...
            <div class="controls">
              <input type="text"  name="password" class="input-normal control-text" style="height:30px;">
				...
				<div class="control-group span8">
					<label class="control-label" style=" padding-top: 0px;">登陆密码：</label>
					<div class="controls">
						<input type="text" name='passwd' class="input-normal control-text" style="height:30px;">
					</div>
				</div>
			</div>
		</form>
			...
			$.ajax({
				...
				success: function(result) {
					$.each(result, function(index, array) {
						...
						var option = "<option value='" + array['location_id'] + "'>" + array['location_name'] + "</option>";
						$city.append(option);
					});
				}
			});
